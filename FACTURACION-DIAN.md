...
Análisis para decidir cuándo y cómo Carly’s pasa a emitir documentos
...
> 3. Si Carly’s ya está obligado y desde cuándo, según su grupo.
...
### El límite de 5 UVT es lo que de verdad afecta a Carly’s
...
**Carly’s no puede resolver esto solo con el tiquete POS electrónico.** Las
...
Para saber cuánto pesa esto en el caso concreto de Carly’s, con datos reales y
...
Carly’s no va a implementar el protocolo de la DIAN por su cuenta: eso implica
...
**Para quién.** Para Carly’s, si lo que se quiere es **exactamente esto**:
...
1. **Hable con el contador del restaurante.** Confirme si Carly’s ya está
