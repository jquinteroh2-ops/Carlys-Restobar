...
const ZONAS: Zona[] = ['salon', 'barra', 'terraza', 'privado']
      ...
      <div className="sticky top-16 z-20 border-b border-noche-800 bg-noche-950/95 backdrop-blur">
        <div className="flex gap-4 px-4 py-2.5 text-xs">
          <span className="text-noche-400">
            Ocupadas <strong className="text-hueso-100">{resumen.ocupadas}/{resumen.total}</strong>
          </span>
          {resumen.listos > 0 && (
          ...
          <span className="ml-auto text-noche-400">
            En salón <strong className="text-hueso-100">{formatoCOP(resumen.venta)}</strong>
          </span>
        </div>
