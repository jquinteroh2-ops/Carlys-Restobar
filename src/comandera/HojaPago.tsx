            ...
            {partes.map((parte, indice) => (
              <li key={indice} className="rounded-xl border border-noche-700 bg-noche-850 p-3">
                <div className="mb-2 flex items-center justify-between gap-2">
                  <span className="text-sm font-medium text-hueso-100">{parte.nombre}</span>
                  {partes.length > 1 && (
                    <button
                      type="button"
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="min-h-toque w-32 rounded-xl border border-noche-700 bg-noche-900 px-3 text-hueso-100 focus:border-dorado-400 focus:outline-none"
                  />
                ...
                {diferencia !== 0 && (
                  <button
                    ...
                    className="mt-2 text-xs font-medium text-dorado-300 underline-offset-2 hover:underline"
                  >
        ...
        {efectivo > 0 && (
          <div className="rounded-xl border border-noche-700 bg-noche-850 p-3">
            <p className="mb-2 text-sm text-noche-300">
              Efectivo a recibir: <strong className="text-hueso-100">{formatoCOP(efectivo)}</strong>
            </p>
            <input
              inputMode="numeric"
              value={recibido}
              ...
              className="min-h-toque w-full rounded-xl border border-noche-700 bg-noche-900 px-3.5 text-hueso-100 placeholder:text-noche-500 focus:border-dorado-400 focus:outline-none"
            />
            {recibidoNumero > 0 && (
              <p
