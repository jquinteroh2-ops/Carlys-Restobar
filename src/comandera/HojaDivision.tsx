            ...
            <ul className="space-y-1.5">
              {valoresIguales.map((valor, i) => (
                ...
                >
                  ...
                  <span className="text-base font-semibold tabular-nums text-hueso-100">
                    {formatoCOP(valor)}
                  </span>
                </li>
              ))}
          ...
          <div className="space-y-3">
                    ...
                    >
                      <span
                        className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-md border ${
                          activo ? 'border-dorado-400 bg-dorado-500' : 'border-noche-600'
                        }`}
                      >
                        {activo && <Check className="h-3.5 w-3.5 text-noche-950" aria-hidden />}
                      </span>
                      <span className="min-w-0 flex-1 truncate text-sm text-hueso-100">
            ...
            <div className="space-y-1.5 rounded-xl border border-noche-700 bg-noche-850 p-3">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-semibold tabular-nums text-hueso-100">
