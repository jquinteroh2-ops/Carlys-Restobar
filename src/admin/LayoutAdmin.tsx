...
import { BarChart3, BookOpen, CalendarClock, LayoutDashboard, Megaphone, Receipt, FileText, MessageSquare, Settings, Users, Wallet } from 'lucide-react'
              ...
              className={({ isActive }) =>
                `flex min-h-[42px] shrink-0 items-center gap-2 rounded-xl px-3.5 text-sm font-medium transition ${
                  isActive
                    ...
                    : 'text-noche-300 hover:bg-noche-800 hover:text-hueso-100'
                }`
              }
            >
