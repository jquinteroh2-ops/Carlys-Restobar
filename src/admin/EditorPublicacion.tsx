  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        {/* ---------- La foto ---------- */}
        <div>
          <span className="mb-1.5 block text-sm font-medium text-hueso-100">Foto</span>
          {borrador.imagen ? (
            <div className="relative overflow-hidden rounded-xl border border-noche-700">
              ...
              <button
                ...
                className="absolute right-2 top-2 rounded-full bg-noche-950/80 p-2 text-hueso-100"
              >
