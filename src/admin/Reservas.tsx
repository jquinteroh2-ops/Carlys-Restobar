              ...
              >
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    <p className="truncate text-base font-semibold text-hueso-100">
                ...
                {(ocasion || reserva.notas || mesa) && (
                  <div className="mt-2 space-y-1">
                    {ocasion && (
                      <p className="inline-flex items-center gap-1.5 text-xs text-dorado-300">
        ...
        <div className="space-y-3">
          <label className="block">
            ...
            <input
              ...
              className="min-h-toque w-full rounded-xl border border-noche-700 bg-noche-850 px-3.5 text-hueso-100 focus:border-dorado-400 focus:outline-none"
            />
          </label>
          <p className="text-xs text-noche-500">
