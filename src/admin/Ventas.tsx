...
const CAMPO =
  'min-h-toque rounded-xl border border-noche-700 bg-noche-900 px-3 text-hueso-100 focus:border-dorado-400 focus:outline-none'
      ...
      <section className="revelar-corto grid grid-cols-2 gap-2.5 lg:grid-cols-4">
        {[
          ...
          <div key={t.etiqueta} className="rounded-2xl border border-noche-800 bg-noche-900 p-3">
            <p className="text-lg font-bold tabular-nums text-hueso-100">{t.valor}</p>
            ...
            <tbody className="divide-y divide-noche-800">
              {ventas.map((venta) => (
                ...
                >
                  ...
                  <td className="px-3 py-2.5 text-hueso-100">{venta.mesaEtiqueta}</td>
                  ...
                  <td className="px-3 py-2.5 text-right font-semibold tabular-nums text-hueso-100">
