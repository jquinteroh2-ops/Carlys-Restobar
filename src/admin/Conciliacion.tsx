  ...
  return (
    <div className="space-y-4">
      ...
      {datos.adaptador === 'manual' && (
        <div className="flex items-start gap-2 rounded-xl border border-dorado-400/35 bg-dorado-500/10 px-3 py-2.5 text-sm text-dorado-200">
          <FileWarning className="mt-0.5 h-4 w-4 shrink-0" aria-hidden />
          <p>
            Carly’s no está conectado a ningún sistema contable todavía. Estas ventas hay que
        ...
        <div className="flex flex-wrap items-end gap-3">
          <label className="text-xs uppercase tracking-wide text-noche-400">
            ...
            <input
              ...
              className="mt-1 block min-h-[40px] rounded-xl border border-noche-700 bg-noche-900 px-3 text-sm text-hueso-100"
            />
          </label>
          <label className="text-xs uppercase tracking-wide text-noche-400">
            Hasta
                  ...
                  {visibles.map((fila) => {
                    ...
                    return (
                      <tr key={fila.envioId} className="align-top">
                        <td className="px-3 py-2.5 font-medium text-hueso-100">
                          #{fila.numeroComanda}
                        </td>
                        <td className="px-3 py-2.5 text-noche-300">
                          {formatoFechaHora(fila.fechaVenta)}
                        </td>
                        <td className="px-3 py-2.5 text-right tabular-nums text-hueso-100">
