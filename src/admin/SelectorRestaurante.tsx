  ...
  return (
    <div ref={contenedor} className="relative shrink-0">
      <button
        ...
        className="flex min-h-[40px] items-center gap-2 rounded-xl border border-noche-700 bg-noche-900 px-3 text-sm font-medium text-hueso-100 transition hover:bg-noche-800"
      >
        <Store className="h-4 w-4 text-dorado-300" aria-hidden />
      ...
      {abierto && (
        ...
        >
          ...
          <div
            role="menuitem"
            aria-current="true"
            className="flex items-center gap-2.5 bg-dorado-500/10 px-3.5 py-2.5 text-sm text-hueso-100"
          >
            <Check className="h-4 w-4 shrink-0 text-dorado-300" aria-hidden />
          ...
          */}
          <a
            ...
            onClick={cruzar}
            aria-busy={cruzando}
            className="flex items-center gap-2.5 border-t border-noche-800 px-3.5 py-2.5 text-sm text-hueso-100 transition hover:bg-noche-800"
          >
            {cruzando ? (
              <Loader2 className="h-4 w-4 shrink-0 animate-spin text-dorado-300" aria-hidden />
            ) : (
              <ArrowUpRight className="h-4 w-4 shrink-0 text-dorado-300" aria-hidden />
            )}
