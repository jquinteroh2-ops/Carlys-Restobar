    ...
    <section className="revelar-corto rounded-2xl border border-noche-800 bg-noche-900 p-4">
      <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          {visible ? (
            <Eye className="h-4 w-4 text-dorado-300" aria-hidden />
          ) : (
      ...
      <input
        ...
        className="mb-3 w-full min-h-toque rounded-xl border border-noche-700 bg-noche-950 px-3 text-hueso-100 focus:border-dorado-400 focus:outline-none"
      />
      ...
      <textarea
        ...
        rows={7}
        className="w-full rounded-xl border border-noche-700 bg-noche-950 p-3 text-sm leading-relaxed text-hueso-100 focus:border-dorado-400 focus:outline-none"
