...
export function ZonasDomicilio({ ajustes }: { ajustes: Ajustes }) {
  ...
  const campo =
    'min-h-toque w-full rounded-xl border border-noche-700 bg-noche-850 px-3.5 text-hueso-100 focus:border-dorado-400 focus:outline-none'
  ...
  return (
    <section className="revelar-corto rounded-2xl border border-noche-800 bg-noche-900 p-4 lg:col-span-2">
      ...
      {/* ---------- Pausa del canal ---------- */}
      <div className="mb-4 rounded-xl border border-dorado-400/30 bg-noche-850 p-3">
        <Interruptor
