...
export default function Configuracion() {
  ...
  const porZona = (['salon', 'barra', 'terraza', 'privado'] as const).map((zona) => ({
    zona,
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-2">
      ...
      <section className="revelar-corto rounded-2xl border border-noche-800 bg-noche-900 p-4">
        <h2 className="mb-1 flex items-center gap-2 text-sm font-semibold text-hueso-100">
          ...
          <label className="block flex-1">
            ...
            <div className="relative">
              <input
                ...
                className="min-h-toque w-full rounded-xl border border-noche-700 bg-noche-850 px-3.5 pr-9 text-hueso-100 focus:border-dorado-400 focus:outline-none"
              />
        ...
        <p className="mt-3 rounded-xl border border-noche-800 bg-noche-850 px-3 py-2 text-xs text-noche-400">
          ...
          <strong className="text-hueso-100">
      ...
      <section className="revelar-corto rounded-2xl border border-noche-800 bg-noche-900 p-4">
        <div className="mb-3 flex items-center justify-between gap-3">
          <h2 className="flex items-center gap-2 text-sm font-semibold text-hueso-100">
          ...
          {usuarios.map((usuario) => (
            ...
            >
              ...
              */}
              ...
              >
                <p className="truncate text-sm text-hueso-100">{usuario.nombre}</p>
              ...
              <div className="flex flex-wrap gap-1.5">
                {deLaZona.map((mesa) => (
                  <button
                    ...
                    className="flex h-10 min-w-[40px] flex-col items-center justify-center rounded-lg border border-noche-700 bg-noche-850 px-1.5 text-xs transition hover:border-dorado-400"
                  >
                    <span className="font-semibold text-hueso-100">{mesa.numero}</span>
