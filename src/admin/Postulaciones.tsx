                ...
                {datos.contenido.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5">
                      <span className="block text-hueso-100">{p.nombreCompleto}</span>
      ...
      <HojaInferior abierta={detalle !== null} onCerrar={() => setDetalle(null)} titulo="Postulación">
        {detalle && (
          <div className="space-y-4 pb-4">
            <div>
              <h3 className="text-lg font-semibold text-hueso-100">{detalle.nombreCompleto}</h3>
            ...
            {detalle.mensaje && (
              <div className="rounded-xl border border-noche-800 bg-noche-900 p-3">
                ...
                <p className="text-sm leading-relaxed text-hueso-100/85">{detalle.mensaje}</p>
              </div>
            )}
