...
const CAMPO =
  'min-h-toque rounded-xl border border-noche-700 bg-noche-900 px-3 text-sm text-hueso-100 focus:border-dorado-400 focus:outline-none'
            ...
            <table className="w-full min-w-[52rem] text-sm">
              ...
              <tbody className="divide-y divide-noche-800">
                {datos.contenido.map((s) => (
                  ...
                  >
                    <td className="whitespace-nowrap px-3 py-2.5 font-medium tabular-nums text-hueso-100">
                      {s.radicado}
                      {s.tieneAdjunto && (
                    ...
                    <td className="max-w-xs px-3 py-2.5">
                      <span className="block truncate text-hueso-100">{s.asunto}</span>
        ...
        {detalle && (
          <div className="space-y-4 pb-4">
            <div>
              ...
              <h3 className="mt-2 text-lg font-semibold text-hueso-100">{detalle.asunto}</h3>
            ...
            <div className="flex flex-wrap gap-2">
              <a
                ...
                className="flex min-h-[40px] items-center gap-2 rounded-xl border border-noche-700 bg-noche-900 px-3.5 text-sm text-hueso-100 transition hover:bg-noche-800"
              >
                <Mail className="h-4 w-4 text-dorado-300" aria-hidden />
                {detalle.email}
              </a>
              {detalle.telefono && (
                <a
                  ...
                  className="flex min-h-[40px] items-center gap-2 rounded-xl border border-noche-700 bg-noche-900 px-3.5 text-sm text-hueso-100 transition hover:bg-noche-800"
                >
                  <Phone className="h-4 w-4 text-dorado-300" aria-hidden />
                  {detalle.telefono}
                </a>
              )}
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full rounded-xl border border-noche-700 bg-noche-900 p-3 text-sm text-hueso-100 focus:border-dorado-400 focus:outline-none"
