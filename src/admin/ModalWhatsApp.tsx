    ...
    >
      <div className="space-y-2">
        ...
        <textarea
          ...
          rows={9}
          className="w-full rounded-xl border border-noche-700 bg-noche-850 px-3.5 py-3 text-sm leading-relaxed text-hueso-100 focus:border-dorado-400 focus:outline-none"
        />
      </div>
    </HojaInferior>
  )
