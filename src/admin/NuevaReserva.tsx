        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <input
              ...
              className="min-h-[44px] w-20 rounded-xl border border-noche-700 bg-noche-850 px-3 text-center text-hueso-100 focus:border-dorado-400 focus:outline-none"
            />
          </div>
        </div>
            ...
            <div className="mt-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                {libres.map((mesa) => (
                  ...
                  >
                    <span className="text-base font-bold text-hueso-100">{mesa.numero}</span>
