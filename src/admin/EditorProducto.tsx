...
const CAMPO =
  'min-h-toque w-full rounded-xl border border-noche-700 bg-noche-850 px-3.5 text-hueso-100 placeholder:text-noche-500 focus:border-dorado-400 focus:outline-none'
    ...
    >
      <div className="space-y-4">
              ...
              {fotos.map((foto, i) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="absolute right-1 top-1 rounded-full bg-noche-950/85 p-1.5 text-hueso-100"
                  >
                    <X className="h-3.5 w-3.5" aria-hidden />
                  </button>

                  {i === 0 ? (
                    <span className="absolute inset-x-0 bottom-0 bg-noche-950/85 py-1 text-center text-[0.65rem] uppercase tracking-wide text-dorado-300">
                      Portada
                    </span>
                  ) : (
                    <button
                      ...
                      className="absolute inset-x-0 bottom-0 bg-noche-950/85 py-1 text-center text-[0.65rem] uppercase tracking-wide text-noche-300 hover:text-hueso-100"
                    >
                      Hacer portada
                    </button>
                  )}
        ...
        <div className="rounded-xl border border-noche-800 bg-noche-900/60 p-3">
          <div className="mb-2.5 flex items-center justify-between">
            ...
            {borrador.precioPromocional ? (
              <button
                type="button"
                className="text-xs text-dorado-300"
                onClick={() =>
        ...
        <div className="flex items-center justify-between gap-3 rounded-xl border border-noche-700 bg-noche-850 px-3.5 py-3">
          <span className="text-sm text-hueso-100">Disponible hoy</span>
          <Interruptor
        ...
        <div>
          <div className="mb-2 flex items-center justify-between gap-2">
            <span className="text-sm font-semibold text-hueso-100">Modificadores</span>
                  ...
                  <ul className="mt-2 space-y-1.5">
                    ...
                    <li>
                      <button
                        ...
                        className="text-xs font-medium text-dorado-300 hover:underline"
                      >
                        + Otra opción
                      </button>
                    </li>
