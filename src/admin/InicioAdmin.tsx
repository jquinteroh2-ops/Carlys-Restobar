    ...
    <div className="space-y-4">
      ...
      <section className="revelar-corto entrada-escalonada grid grid-cols-2 gap-2.5 lg:grid-cols-6">
        {tarjetas.map(({ icono: Icono, etiqueta, valor }) => (
          <div key={etiqueta} className="rounded-2xl border border-noche-800 bg-noche-900 p-3">
            ...
            <p className="text-lg font-bold tabular-nums text-hueso-100">{valor}</p>
          ...
          <ul className="space-y-1.5">
            {alertas.map((alerta) => (
              <li key={alerta.id}>
                ...
                >
                  <span className="min-w-0 truncate text-sm text-hueso-100">{alerta.mensaje}</span>
      ...
      <div className="revelar-corto entrada-escalonada grid gap-4 lg:grid-cols-3">
        ...
        <section className="revelar-corto rounded-2xl border border-noche-800 bg-noche-900 p-3 lg:col-span-2">
          <h2 className="mb-2.5 flex items-center justify-between gap-2 text-sm font-semibold text-hueso-100">
                ...
                <li key={mesa.id}>
                  ...
                  >
                    ...
                    <span className="min-w-0 flex-1">
                      <span className="block truncate text-sm font-medium text-hueso-100">
                    ...
                    <span className="shrink-0 text-right">
                      <span className="block text-sm font-semibold tabular-nums text-hueso-100">
          ...
          <h2 className="mb-2.5 flex items-center justify-between gap-2 text-sm font-semibold text-hueso-100">
            ...
            {solicitudes.length > 0 && (
              <button
                ...
                className="rounded-lg bg-dorado-500/15 px-2 py-0.5 text-xs font-semibold text-dorado-300 transition hover:bg-dorado-500/25"
              >
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      <p className="truncate text-sm font-medium text-hueso-100">
