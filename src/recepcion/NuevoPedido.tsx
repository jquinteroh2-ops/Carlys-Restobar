    ...
    >
      <header className="flex items-center gap-3 border-b border-noche-800 px-4 py-3">
        <div className="min-w-0 flex-1">
          <h2 className="truncate text-base font-semibold text-hueso-100">
        ...
        <button
          ...
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl text-noche-400 transition hover:bg-noche-800 hover:text-hueso-100"
        >
                    ...
                    {zonas.length === 0 ? (
                      ...
                      <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                        {zonas.map((z) => (
                          ...
                          >
                            <span className="truncate text-sm text-hueso-100">{z.nombre}</span>
              ...
              <div className="border-b border-noche-800 px-4 py-2.5">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="min-h-toque w-full rounded-xl border border-noche-700 bg-noche-900 pl-9 pr-3 text-hueso-100 placeholder:text-noche-500 focus:border-dorado-400 focus:outline-none"
                  />
                </div>
                      ...
                      <button
                        ...
                        className={`shrink-0 rounded-lg px-3 py-1.5 text-sm transition ${
                          categoriaVisible === c.id
                            ? 'bg-dorado-500 font-medium text-carbon-950'
                ...
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 xl:grid-cols-4">
                  {visibles.map((item) => (
                    <button
                      ...
                      className="flex min-h-[76px] flex-col justify-between rounded-xl border border-noche-700 bg-noche-900 p-2.5 text-left transition hover:border-dorado-400/60 hover:bg-noche-850"
                    >
                      <span className="text-sm leading-snug text-hueso-100">{item.nombre}</span>
                      <span className="mt-1 text-sm tabular-nums text-dorado-300">
            ...
            <aside className="flex min-h-0 shrink-0 flex-col border-t border-noche-800 lg:w-[360px] lg:border-l-0 lg:border-t-0">
                      ...
                      <li key={linea.clave} className="rounded-xl border border-noche-800 bg-noche-900 p-2.5">
                        <div className="flex items-start justify-between gap-2">
                          <div className="min-w-0">
                            <p className="text-sm text-hueso-100">{linea.item.nombre}</p>
                          ...
                          <span className="shrink-0 text-sm tabular-nums text-hueso-100">
              ...
              <div className="border-t border-noche-800 px-3 pt-3 pb-segura">
                <dl className="mb-3 space-y-1 text-sm">
                  ...
                  <div className="flex justify-between border-t border-noche-800 pt-1 font-semibold text-hueso-100">
