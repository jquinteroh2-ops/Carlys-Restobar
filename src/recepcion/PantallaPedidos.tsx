...
export default function PantallaPedidos() {
   ...
   * estaría mal.
   *
   * No es un documento fiscal. El de esta venta lo emite el sistema contable, y no se
      ...
      {!sonidoActivo && (
        <p className="border-b border-noche-800 bg-noche-900 px-4 py-2 text-xs text-noche-400">
          ...
          <button
            ...
            className="font-medium text-dorado-300 underline"
          >
            ...
            return (
              ...
              >
                <header className="flex items-center justify-between border-b border-noche-800 px-3 py-2">
                  ...
                  <span className="rounded-lg bg-noche-800 px-2 py-0.5 text-xs font-semibold text-hueso-100">
                    {lista.length}
                  </span>
                </header>
            ...
            {MOTIVOS_RECHAZO.map((texto) => (
              <button
                ...
                className={`rounded-xl border px-3 py-2 text-left text-xs transition ${
                  motivo === texto
                    ? 'border-dorado-400 bg-dorado-500/10 text-dorado-300'
                      ...
                      <button
                        ...
                        className={`min-h-toque rounded-xl border px-4 text-sm transition ${
                          repartidorId === quien.id
                            ? 'border-dorado-400 bg-dorado-500/10 text-dorado-300'
                            : 'border-noche-700 bg-noche-850 text-hueso-100 hover:border-noche-600'
                        }`}
                      >
                        {quien.nombre}
                      </button>
  ...
  return (
    <article
      className={`rounded-2xl border bg-noche-900 p-3 transition ${
        reciente ? 'border-dorado-400 ring-2 ring-dorado-400/40' : 'border-noche-800'
      }`}
    >
      <header className="mb-2 flex items-start justify-between gap-2">
        <div className="min-w-0">
          <p className="flex items-center gap-1.5 truncate font-semibold text-hueso-100">
            {orden.tipo === 'domicilio' ? (
              <Bike className="h-4 w-4 shrink-0 text-dorado-300" aria-hidden />
            ) : (
              <ShoppingBag className="h-4 w-4 shrink-0 text-dorado-300" aria-hidden />
            )}
      ...
      */}
            ...
            <div className="mt-1.5">
              <div className="flex gap-1.5">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1 rounded-lg border border-noche-700 bg-noche-850 px-2 py-1 text-xs text-hueso-100 transition hover:border-dorado-400/50"
                >
          ...
          {(orden.ubicacion || orden.cliente?.direccion) && (
            <>
              ...
              <button
                ...
                className="mt-1.5 inline-flex items-center gap-1 rounded-lg border border-noche-700 bg-noche-850 px-2 py-1 text-xs text-noche-300 transition hover:border-dorado-400/50"
              >
      ...
      <ul className="mb-2 space-y-1">
        {orden.items
          ...
          .map((item) => (
            <li key={item.id} className="text-sm text-hueso-100">
              <span className="mr-1.5 font-semibold text-dorado-300">{item.cantidad}×</span>
              {item.nombre}
      ...
      <div className="mb-3 border-t border-noche-800 pt-2 text-xs">
        ...
        <div className="mt-1 flex justify-between font-semibold text-hueso-100">
          <span>Total</span>
      ...
      <div className="mb-2 flex gap-2">
        <a
          ...
          className="flex flex-1 items-center justify-center gap-1.5 rounded-xl border border-noche-700 bg-noche-850 px-2 py-2 text-xs text-hueso-100 transition hover:border-noche-600"
        >
      ...
      {orden.repartidor && (
        <p className="mt-2 text-xs text-noche-400">
          Lo lleva <span className="text-hueso-100">{orden.repartidor}</span>
        </p>
      )}
...
function EnlacesCliente({ pedido, mensaje }: { pedido: PedidoEnRecepcion; mensaje: string }) {
  ...
  return (
    <div className="rounded-2xl border border-noche-700 bg-noche-850 p-3">
      <p className="mb-2 text-xs font-semibold uppercase tracking-wider text-dorado-300">
      ...
      <div className="flex gap-2">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-noche-700 px-3 py-2 text-sm text-hueso-100 transition hover:border-noche-600"
        >
...
function EntregaDelDomicilio({ pedido }: { pedido: PedidoEnRecepcion }) {
  ...
  const chip =
    'inline-flex items-center gap-1.5 rounded-xl border border-noche-700 px-3 py-2 text-sm text-hueso-100 transition hover:border-dorado-400/50'
  ...
  return (
    <div className="rounded-2xl border border-noche-700 bg-noche-850 p-3">
      ...
      <p className="flex items-start gap-1.5 text-sm text-hueso-100">
