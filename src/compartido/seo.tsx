...
const PUBLICAS: Record<string, Ficha> = {
  '/': {
    titulo: `${RESTAURANTE.nombreCompleto} · Restobar en ${RESTAURANTE.ciudad}`,
    descripcion:
      'Restobar en Turbaco, Bolívar: cocina, coctelería y música. Vea las promociones del mes,' +
  ...
  '/carta': {
    ...
    descripcion:
      'Para picar, hamburguesas, platos fuertes, postres, cocteles, cerveza y licores.' +
      ' Vea la carta completa del Carly’s Restobar en Turbaco.',
    indexable: true,
  },
  '/reservar': {
    titulo: `Reservar mesa · ${RESTAURANTE.nombreCompleto}, ${RESTAURANTE.ciudad}`,
    descripcion:
      'Reserve su mesa en el Carly’s Restobar, Turbaco. Cumpleaños, aniversarios y cenas de' +
  ...
  '/trabaja-con-nosotros': {
    ...
    descripcion:
      'Deje su hoja de vida en el Carly’s Restobar, Turbaco. Meseros, cocina, caja,' +
  ...
  '/pqr': {
    ...
    descripcion:
      'Radique una petición, queja, reclamo, sugerencia o felicitación en Carly’s Restobar,' +
      ' Turbaco. Recibe número de radicado y respuesta dentro del plazo de ley.',
    indexable: true,
  },
  ...
  '/politica-de-datos': {
    ...
    descripcion:
      'Cómo trata el Carly’s Restobar los datos personales que usted entrega, conforme' +
