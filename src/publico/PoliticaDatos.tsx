...
export default function PoliticaDatos() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-5 py-12 sm:py-16">
      <h1 className="font-titulo text-3xl text-hueso-100 sm:text-4xl font-light leading-tight">
        Política de tratamiento de datos personales
      </h1>
      <p className="mt-2 text-sm text-hueso-100/50">
        {RESTAURANTE.nombreCompleto} · NIT {DATOS_FISCALES.nitCompleto}
      </p>

      <div className="mt-6 flex items-start gap-3 border border-dorado-400/35 bg-dorado-500/10 p-4 text-sm text-dorado-200">
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-hueso-100/75">
        <section>
          <h2 className="mb-2 font-titulo text-xl text-hueso-100 font-light leading-tight">Quién responde por sus datos</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-titulo text-xl text-hueso-100 font-light leading-tight">Para qué los usamos</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-titulo text-xl text-hueso-100 font-light leading-tight">Cuánto tiempo los guardamos</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-titulo text-xl text-hueso-100 font-light leading-tight">Sus derechos</h2>
          <p>
          ...
          <p className="mt-3">
            ...
            <span className="text-dorado-300">{DATOS_FISCALES.correo}</span> o comuníquese al{' '}
            <span className="text-dorado-300">{ficha.telefono}</span>. Atendemos su
            solicitud en los términos que fija la ley.
          </p>
        </section>

        <section>
          <h2 className="mb-2 font-titulo text-xl text-hueso-100 font-light leading-tight">Seguridad</h2>
          <p>
