  ...
  return (
    <div className="flex min-h-dvh flex-col bg-noche-950 px-4 py-8">
      <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
        <Link
          to="/"
          className="mb-8 inline-flex items-center gap-2 self-start text-sm text-noche-400 transition hover:text-hueso-100"
        >
        ...
        <div className="mb-8">
          <p className="font-titulo text-2xl text-dorado-300 font-light leading-tight">CARLY’S</p>
          <h1 className="mt-3 font-titulo text-3xl text-hueso-100 font-light leading-tight">Acceso del personal</h1>
        ...
        {avisoDelCruce && (
          <p
            role="status"
            className="mb-5 bg-estado-proceso-suave px-3.5 py-3 text-sm leading-relaxed text-hueso-100"
          >
            {avisoDelCruce}
          </p>
        )}
        ...
        */}
        {hayCuentas ? (
          <div className="mt-10 border-noche-700 bg-noche-900 p-4">
            <p className="mb-3 text-xs text-dorado-300 font-semibold">
              ...
              {demostracion.cuentas.map((cuenta) => (
                <li key={cuenta.usuario}>
                  <button
                    ...
                    className="flex w-full items-center justify-between gap-3 border-noche-700 bg-noche-850 px-3 py-2.5 text-left transition hover:bg-carbon-800 hover:bg-noche-800"
                  >
                    <span>
                      <span className="block text-sm font-medium text-hueso-100">
