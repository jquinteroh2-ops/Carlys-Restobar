      ...
      */}
      <div className={`relative overflow-hidden ${className}`}>
        ...
        {!activo && (
          ...
          >
            <span className="flex items-center gap-1.5 rounded-full bg-noche-950/75 px-2.5 py-1 text-xs text-hueso-100/80 opacity-0 transition group-hover:opacity-100 group-focus-visible:opacity-100">
