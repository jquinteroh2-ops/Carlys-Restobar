    ...
    <>
      <header className="flex items-start gap-3 border-b border-noche-800 px-4 py-3.5">
        <div className="min-w-0 flex-1">
          <h2 className="truncate text-base font-semibold text-hueso-100">{titulo}</h2>
        ...
        <button
          ...
          onClick={onCerrar}
          aria-label="Cerrar"
          className="-mr-1 flex h-11 w-11 shrink-0 items-center justify-center rounded-xl text-noche-400 transition hover:bg-noche-800 hover:text-hueso-100"
        >
