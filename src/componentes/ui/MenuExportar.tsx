      ...
      {abierto && (
        ...
        >
          <button
            ...
            className="flex w-full items-center gap-2.5 px-3.5 py-2.5 text-left text-sm text-hueso-100 transition hover:bg-noche-800"
          >
            <FileSpreadsheet className="h-4 w-4 text-dorado-300" aria-hidden />
            Excel (.xlsx)
          </button>
          <button
            type="button"
            ...
            className="flex w-full items-center gap-2.5 border-t border-noche-800 px-3.5 py-2.5 text-left text-sm text-hueso-100 transition hover:bg-noche-800"
          >
            <FileText className="h-4 w-4 text-dorado-300" aria-hidden />
            PDF
          </button>
        </div>
      )}
