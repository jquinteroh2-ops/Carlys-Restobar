...
export function Contador({
  ...
  return (
    <div className="inline-flex items-center gap-1 rounded-xl border border-noche-700 bg-noche-850 p-1">
      <button
        ...
        className={`${lado} flex items-center justify-center rounded-lg transition active:scale-95 ${
          quitaria
            ...
            : 'text-hueso-100 hover:bg-noche-700'
        }`}
      >
      ...
      <span
        className={`min-w-[2ch] text-center font-semibold tabular-nums text-hueso-100 ${
      ...
      <button
        ...
        className={`${lado} flex items-center justify-center rounded-lg text-hueso-100 transition hover:bg-noche-700 active:scale-95 disabled:opacity-40`}
      >
