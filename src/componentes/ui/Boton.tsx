 ...
 *
 * Va en PILDORA —esquina redondeada del todo— y con el texto en negrita y en
 * caja normal, no en versalitas espaciadas. Es la pieza que mas se repite en
 * el sistema y por eso es la que mas marca el tono del conjunto: el rectangulo
 * de esquina viva con versalitas se lee formal, y la pildora se lee de barra.
 */
const VARIANTES: Record<Variante, string> = {
  principal: 'bg-dorado-500 text-carbon-950 hover:bg-dorado-400 active:bg-dorado-600 font-semibold',
  secundario: 'bg-noche-700 text-hueso-100 hover:bg-noche-600 active:bg-noche-800',
  fantasma: 'bg-transparent text-noche-300 hover:bg-noche-800 hover:text-hueso-100',
