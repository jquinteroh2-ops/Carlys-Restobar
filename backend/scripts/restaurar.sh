#!/usr/bin/env bash
#
# Restauración de un respaldo de Carly’s.
#
...
#
#   ./restaurar.sh respaldos/carlys-20260820T210000Z.sql.gz
#
...
if [ -z "$ARCHIVO" ]; then
  ...
  ls -1t ./respaldos/carlys-*.sql.gz 2>/dev/null | head -10 >&2 || echo "  (ninguno)" >&2
  exit 1
fi
