package co.carlys.infraestructura.imagenes;
...
class AlmacenCloudinaryTest {
  ...
  void conVersion() {
    String direccion =
        "https://res.cloudinary.com/carlys/image/upload/v1712345678/carlys/terraza.jpg";
    assertThat(AlmacenCloudinary.identificadorDe(direccion)).isEqualTo("carlys/terraza");
  }

  @Test
  @DisplayName("saca el identificador cuando Cloudinary no puso version")
  void sinVersion() {
    String direccion = "https://res.cloudinary.com/carlys/image/upload/carlys/terraza.jpg";
    assertThat(AlmacenCloudinary.identificadorDe(direccion)).isEqualTo("carlys/terraza");
  }
  ...
  void carpetaQueEmpiezaPorV() {
    ...
    String direccion = "https://res.cloudinary.com/carlys/image/upload/verano/foto.jpg";
  ...
  void sinExtension() {
    String direccion = "https://res.cloudinary.com/carlys/image/upload/v1/carlys/terraza";
    assertThat(AlmacenCloudinary.identificadorDe(direccion)).isEqualTo("carlys/terraza");
  }
