...
class CalculadoraCuentaTest {
  ...
  private static Orden domicilio(List<ItemOrden> items, long costoEnvio) {
    ...
    orden.setTipo(co.carlys.dominio.pedido.TipoPedido.DOMICILIO);
    orden.setEstadoPedido(co.carlys.dominio.pedido.EstadoPedido.NUEVO);
  ...
  class Domicilio {
    ...
    void paraLlevarNoCobraEnvio() {
      ...
      orden.setTipo(co.carlys.dominio.pedido.TipoPedido.LLEVAR);
