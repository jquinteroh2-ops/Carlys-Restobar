...
--
-- Carly’s dejo de emitir documentos fiscales: los emite Globalsoft. Esta tabla
...
create table erp_outbox (
    ...
    -- contador cruza una venta de Carly’s contra su contabilidad.
...
comment on table erp_outbox is
  'Ventas en camino al ERP externo. Carly’s no emite documentos fiscales.';
