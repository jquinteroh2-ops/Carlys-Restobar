package co.carlys.aplicacion.dto;
...
import co.carlys.dominio.comanda.ModificadorSeleccionado;
...
import co.carlys.dominio.salon.Zona;
...
public final class Dtos {
   ...
   * haya puesto CARLYS_CLAVE_DEMO— `activa` es false, `clave` va vacia y la
  ...
  public record NuevaReserva(
      ...
      Instant fechaHora,
      int personas,
      co.carlys.dominio.reserva.Ocasion ocasion,
      String notas,
  ...
  public record CambioEstadoReserva(
      co.carlys.dominio.reserva.EstadoReserva estado, String mesaAsignadaId) {}
