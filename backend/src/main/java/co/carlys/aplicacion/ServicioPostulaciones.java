...
import co.carlys.dominio.reclutamiento.TipoDocumento;
...
public class ServicioPostulaciones {
  ...
  public ServicioPostulaciones(
      ...
      GeneradorIds ids,
      Reloj reloj,
      @Value("${carlys.reclutamiento.correo-administrador:}") String correoDelAdministrador,
      @Value("${carlys.reclutamiento.dias-sin-repetir:30}") int diasSinRepetir) {
