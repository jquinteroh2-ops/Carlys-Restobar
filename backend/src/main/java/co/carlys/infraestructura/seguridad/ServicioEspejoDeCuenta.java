...
/**
 * Mantiene igual la cuenta del dueño en las dos sedes.
 *
 * <p>El dueño tiene una cuenta de administrador en cada local, y sin esto
 * serían dos cuentas de verdad: cambiar la clave en Turbaco no la cambiaría en
 * Arjona, y habría que acordarse de hacerlo dos veces y de cuál era cuál. Así,
 ...
 * de cada sede: suspenderle el acceso a un local no tiene por qué cerrarle el
 * otro.
 *
...
public class ServicioEspejoDeCuenta {
  ...
  public ServicioEspejoDeCuenta(
      LlaveDeCruce llave, @Value("${carlys.cruce.api-hermana:}") String apiHermana) {
    this.llave = llave;
  ...
  /** Abre un sobre que llegó dla otra sede. Vacío si no es de fiar. */
