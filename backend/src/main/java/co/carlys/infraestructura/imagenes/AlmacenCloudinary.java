...
import co.carlys.dominio.puertos.AlmacenDeImagenes;
...
public class AlmacenCloudinary implements AlmacenDeImagenes {
  ...
  private static final String CARPETA = "carlys";
   ...
   *   https://res.cloudinary.com/NUBE/image/upload/v1712345678/carlys/ab12cd.jpg
   * y el identificador es «carlys/ab12cd»: lo que hay despues de la version y
