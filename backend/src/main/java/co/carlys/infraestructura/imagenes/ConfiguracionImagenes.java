...
public class ConfiguracionImagenes {
  ...
  public AlmacenDeImagenes almacenDeImagenes(
      @Value("${carlys.imagenes.ruta}") String ruta,
      @Value("${carlys.imagenes.cloudinary.nombre:}") String nombreNube,
      @Value("${carlys.imagenes.cloudinary.llave:}") String llave,
      @Value("${carlys.imagenes.cloudinary.secreto:}") String secreto) {
