...
import co.carlys.aplicacion.ServicioAdministracion;
import co.carlys.aplicacion.ServicioAjustes;
import co.carlys.aplicacion.ServicioSalon;
...
public class ControladorAdministracion {
  ...
  public CierreCaja cerrarTurno(
      @AuthenticationPrincipal co.carlys.infraestructura.seguridad.ServicioTokens.Credencial credencial) {
