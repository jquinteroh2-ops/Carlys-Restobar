...
import co.carlys.aplicacion.ServicioAnticipos;
import co.carlys.infraestructura.pagos.ValidadorFirmaWompi;
...
public class ControladorWebhookWompi {
  ...
  public ControladorWebhookWompi(
      ServicioAnticipos servicio, @Value("${carlys.wompi.secreto-eventos}") String secretoEventos) {
