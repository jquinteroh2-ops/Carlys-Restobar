package co.carlys.infraestructura.export;

import co.carlys.dominio.puertos.Exportador;
import co.carlys.dominio.reporte.ColumnaReporte;
import co.carlys.dominio.reporte.DefinicionReporte;
import co.carlys.dominio.reporte.FilaReporte;
...
public class ExportadorPdf implements Exportador {
  ...
  public ExportadorPdf(
      @Value("${carlys.reportes.razon-social:Carly’s Restobar}") String razonSocial,
      @Value("${carlys.reportes.nit:}") String nit) {
