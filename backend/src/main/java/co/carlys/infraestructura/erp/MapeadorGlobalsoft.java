...
/**
 * Traduce una venta de Carly’s al vocabulario de Globalsoft.
 *
 ...
 * identificador de Carly’s en la columna del codigo. Globalsoft tiene su
...
public final class MapeadorGlobalsoft {
   ...
   * llame «Picada de la casa; para dos» partiria la fila en dos y correria todas
