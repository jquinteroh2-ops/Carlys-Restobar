...
import co.carlys.dominio.caja.Turno;
import co.carlys.dominio.carta.ItemCarta;
import co.carlys.dominio.cobro.CalculadoraCuenta;
import co.carlys.dominio.cobro.Cuenta;
import co.carlys.dominio.cobro.DivisionPago;
import co.carlys.dominio.cobro.MetodoPago;
import co.carlys.dominio.cobro.Pago;
import co.carlys.dominio.comanda.EstadoItem;
import co.carlys.dominio.comanda.EstadoOrden;
import co.carlys.dominio.comanda.ItemOrden;
import co.carlys.dominio.comanda.Orden;
import co.carlys.dominio.pedido.ClienteExterno;
import co.carlys.dominio.pedido.EstadoPedido;
import co.carlys.dominio.pedido.TipoPedido;
import co.carlys.dominio.pedido.UbicacionEntrega;
...
import co.carlys.dominio.reserva.EstadoReserva;
import co.carlys.dominio.reserva.Ocasion;
import co.carlys.dominio.reserva.Reserva;
import co.carlys.dominio.salon.EstadoMesa;
 ...
 *
 * <ul>
 *   <li>Quitar CARLYS_CLAVE_DEMO y redesplegar deja el sistema limpio, sin
  ...
  private void sembrar() {
    ...
    registro.warn(
        "Datos de demostración sembrados: {} ventas, {} mesas abiertas, {} pedidos en recepción,"
            + " {} reservas. Se retiran solos al quitar CARLYS_CLAVE_DEMO.",
        ventas,
        enMesa,
        enRecepcion,
        agendadas);
